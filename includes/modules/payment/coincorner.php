...
class coincorner
{
  ...
  function install()
  {
    ...
    tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('Set Pending Payment Status', 'MODULE_PAYMENT_COINCORNER_PENDING_PAYMENT_STATUS_ID', 0, 'Status for your order when awaiting payment<br />(\'Awaiting Payment\' recommended)', '6', '5', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
    tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('Set Pending Confirmation', 'MODULE_PAYMENT_COINCORNER_PENDING_CONFIRMATION_STATUS_ID', 1, 'Status for your order when your order is pending confirmation<br />(\'Pending Confirmation\' recommended)', '6', '6', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
    tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('Set Cancelled Status', 'MODULE_PAYMENT_COINCORNER_CANCELED_STATUS_ID', -1, 'Status for your order when your order is cancelled<br />(\'Cancelled\' recommended)', '6', '6', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
    tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('Set Paid Order Status', 'MODULE_PAYMENT_COINCORNER_PAID_STATUS_ID', '2', 'Status in your store when CoinCorner order status is paid.<br />(\'Paid\' recommended)', '6', '6', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
